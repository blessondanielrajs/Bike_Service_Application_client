...
try {
  ...
  enqueueTask = callback => {
    ...
    if (supportsMessageChannel) {
      ...
      console.error('This browser does not have a MessageChannel implementation, ' + 'so enqueuing tasks via await act(async () => ...) will fail. ' + 'Please file an issue at https://github.com/testing-library/user-event/issues ' + 'if you encounter this warning.');
    }
  };
}
