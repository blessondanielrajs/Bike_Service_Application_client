...
async function hover(element, init) {
  ...
  _dom.fireEvent.mouseEnter(element, getMouseEventOptions('mouseenter', init));
...
async function unhover(element, init) {
  ...
  _dom.fireEvent.mouseOut(element, getMouseEventOptions('mouseout', init));

  await (0, _tick.tick)();

  _dom.fireEvent.mouseLeave(element, getMouseEventOptions('mouseleave', init));
}
